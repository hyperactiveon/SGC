                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input data-error="Bruh, that email address is invalid" class="form-control" type="text" name="nome" id="nome" placeholder="Nome" <?php echo $required; ?>>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input data-error="Bruh, that email address is invalid" class="form-control" type="text" name="login" id="login" placeholder="Login" <?php echo $required; ?>>
                                        </div>
                                    </div>
                                    <div class="form-group">
