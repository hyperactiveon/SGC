<?php
    ...
    foreach(Fornecedor::ListAll() as $forn){
        $selFornecedores.= '<option value='.$forn->id.'>'.$forn->nome_fantasia.'</option>';
    }
    ...
    foreach(Categoria::ListAll() as $categ){
        $selCategorias.= '<option value='.$categ->id.'>'.$categ->titulo.'</option>';
    }
...
<div class="col-sm-12 col-xs-12">
    <div class="panel panel-info">
        <div class="panel-heading"><h3 class="panel-title">Editar Produto - <?php echo strtoupper($f->titulo); ?></h3></div>
